...
- 无阴影悬浮输入框，可切换默认/Plan 模式、上传多个附件并停止正在运行的回复。
- 左侧菜单统一显示设备、对话、任务、终端与最近会话；最近任务和对话按时间混排。
...
正式发布使用 `v0.1.0` 标签，APK 及完整更新说明见仓库的 GitHub Releases。
...
> 完整使用 0.1.0 的右侧栏、附件、会话重命名和删除功能，需要
> Cyrene Desktop 0.7.0 beta9 或更新版本。
